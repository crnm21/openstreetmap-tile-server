...
if [ "$1" = "append" ]; then
   ...
   service postgresql start
    ...
    # Append data
    sudo -u renderer osm2pgsql -d gis --append --slim -G -S /home/renderer/src/openstreetmap-carto-de/hstore-only.style --hstore --tag-transform-script /home/renderer/src/openstreetmap-carto-de/openstreetmap-carto.lua -C 2048 --number-processes ${THREADS:-4} -p planet_osm /append.osm.pbf
...
if [ "$1" = "import" ]; then
    ...
    # Import data
    sudo -u renderer osm2pgsql -d gis --create --slim -G -S /home/renderer/src/openstreetmap-carto-de/hstore-only.style --hstore --tag-transform-script /home/renderer/src/openstreetmap-carto-de/openstreetmap-carto.lua -C 2048 --number-processes ${THREADS:-4} -p planet_osm /data.osm.pbf
